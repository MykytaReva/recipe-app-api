...
class PrivateRecipeApiTests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = create_user(email='user@example.com', password='test123123')
    ...
    def test_recipe_other_users_recipe_error(self):
        ...
        new_user = create_user(email='user5@example.com', password='pass1234')
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 10,
            'price': Decimal('2.50'),
            'ingredients': [{'name': 'Lemon'}, {'name': 'Garlic Sauce'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_filter_by_tags(self):
        ...
        # self.assertEqual(res.status_code, status.HTTP_200_OK)
        # self.assertEqual(res.data['tags'].count(), 2)
